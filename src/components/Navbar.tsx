...
<NavCategory title="About" className="flex items-center justify-center h-10 sm:h-12 px-4 py-2 border-[3px] rounded-full font-semibold text-base text-[#3a3967] border-[#3a3967] dark:text-gray-200 dark:border-gray-200 hover:text-[#ff8a65] hover:border-[#ff8a65] transition-all duration-300">
  <Link href="/about">About</Link>
</NavCategory> 

<NavCategory title="Shopping List" className="flex items-center justify-center h-10 sm:h-12 px-4 py-2 border-[3px] rounded-full font-semibold text-base text-[#3a3967] border-[#3a3967] dark:text-gray-200 dark:border-gray-200 hover:text-[#ff8a65] hover:border-[#ff8a65] transition-all duration-300">
  <Link href="/shopping-list">Shopping List</Link>
      ...
      <div className="flex items-center space-x-2 sm:space-x-4 mt-4 md:mt-0">
        <Search />
        <ModeToggle />
        {/* <Link href="/login" className="flex items-center justify-center h-10 sm:h-12 px-4 py-2 border-2 rounded-full font-semibold text-base text-[#3a3967] border-[#3a3967] dark:text-gray-200 dark:border-gray-200 hover:text-[#ff8a65] hover:border-[#ff8a65] transition-all duration-300">
          Sign up/Log in
        </Link> */}
      </div>
    </div>
