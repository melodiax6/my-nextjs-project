...
//   // Filter recipes based on searchValue, similar to the filtering logic in recipes/page
//   const filteredRecipes = recipesData.filter(recipe =>
//     recipe.title.toLowerCase().includes(searchValue.toLowerCase())
//   );

//   return (
//     <div className="relative flex flex-col items-center bg-[#FBB5A5] dark:bg-[#FFC8C2] p-3 rounded-full h-12 ml-4 w-full max-w-lg shadow-lg">
...
//       {/* Display filtered recipes in a styled dropdown */}
//       {searchValue && (
