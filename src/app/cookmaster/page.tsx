...
// type RecipeIngredient = { sys: { id: string } };
...
// export default function CookMasterPage() {
//   const [allRecipesData, setAllRecipesData] = useState([]);
//   useEffect(() => {
//     async function fetchData() {
//       const response = await allRecipes();
//       console.log(response);
//       setAllRecipesData(response);
//     }

//     fetchData();
//   }, []);

//   const matchedRecipes = allRecipesData.filter((recipe) =>{
//     const ingredientsLength = recipe.fields?.ingredients.length;

//     const matchedIngredients = 4;

//     return {
//       ...recipe,
//       ratio: ingredientsLength ? ingredientsLength / matchedIngredients : 0,
//     }
//   });
//   return (<div>
